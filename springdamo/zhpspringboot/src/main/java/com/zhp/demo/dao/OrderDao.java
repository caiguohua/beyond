...
//    select p, o from p where p.id = o.id
    ...
    @Query(value = "select o.oid,o.money,o.uid,o.datetime,u.phone,u.name,u.address,p.pname,p.price from order_ o,user u,product p where o.oid = :oid and u.id = o.uid and p.pid = o.pid",nativeQuery = true)
